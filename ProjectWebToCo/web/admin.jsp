        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8"><h2>Sản phẩm (<c:out value="${requestScope.amount}"/>)</h2></div>
                    </div>
                    <div class="drop row dropdown text-left">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Loại sản phẩm
                        </button>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="admin">Tất cả sản phẩm</a>
                            <a class="dropdown-item" href="admin?id=1">Trà Sữa</a>
                            <a class="dropdown-item" href="admin?id=2">Trà Trái Cây</a>
                            <a class="dropdown-item" href="admin?id=3">Đồ uống đặc biệt</a>
                        </div>
                    </div>
                </div>
