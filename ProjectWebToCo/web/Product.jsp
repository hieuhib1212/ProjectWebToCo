<%-- 
    Document   : Product
    Created on : Nov 14, 2020, 4:33:13 PM
    Author     : Hiệu Bùi
--%>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <p><a class="btn btn-lg btn-success" href="#" role="button">Xem Ngay</a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="list-group">
                        <a href="product" class="list-group-item ">Tất Cả Sản Phẩm</a>
                        <c:forEach items = "${requestScope.listdm}" var="dm">   
                            <a href="product?id=${dm.maDanhmuc}" class="list-group-item ">${dm.tenDanhMuc}</a>   
                        </c:forEach>
                    </div>
                </div>
                <!-- /.col-lg-3 -->
                <div class="col-lg-9">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="container ">
                            <div class="row m-4 ">
                                <c:forEach items = "${requestScope.listsp}" var="li">    
                                    <div class="col-lg-4 col-sm-6 portfolio-item text-center mb-5 ">
                                        <div class="card h-100">
                                            <a href="#"><img class="card-img-top" src="${li.imgUrl}" alt=""></a>
                                            <div class="card-body">
                                                <h4 class="card-title">
                                                    <span>${li.tenSanPham}(${li.size})</span>
                                                </h4>
                                                <p class="card-text">${li.gia} VND</p>
                                            </div>
