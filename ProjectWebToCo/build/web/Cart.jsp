<%-- 
    Document   : Cart
    Created on : Dec 15, 2020, 11:03:57 AM
    Author     : Hiệu Bùi
--%>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="p-1">
                                                            <div class="ml-3 d-inline-block align-middle">
                                                                <strong>${d.tenSanPham}</strong>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle"><strong>${d.gia}</strong></td>
                                                    <td class="align-middle">
                                                        <a href="sub?id=${d.maSanPham}"><button class="btnSub">-</button></a> <strong >${d.soLuongSP}</strong>
                                                        <a href="addtocart?id=${d.maSanPham}"><button class="btnAdd">+</button></a>
                                                    </td>
                                                    <td class="align-middle">
                                                        <strong name="total">${d.total} VND</strong>
                                                    </td>
                                                    <td class="align-middle">
                                                        <a href="remove?id=${d.maSanPham}"><button  class="text-dark m-4 ">Delete</button></a>
                                                    </td>
                                                </tr> 
                                            </c:forEach>
                                            <%
                                            ...
                                            <tr>
                                                ...
                                                <td  class="align-middle"></td>
                                                <td  class="align-middle"></td>
                                                <td  class="align-middle"><strong>TỔNG TIỀN: </strong></td>
                                                <td  class="align-middle"><%=(float) session.getAttribute("total") %> VND</td>
                                            </tr>
